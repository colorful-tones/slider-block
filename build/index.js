...
/* harmony export */   DEFAULT_BLOCK_ATTRIBUTES: () => (/* binding */ DEFAULT_BLOCK_ATTRIBUTES),
/* harmony export */   DEFAULT_INNERBLOCK: () => (/* binding */ DEFAULT_INNERBLOCK),
/* harmony export */   DEFAULT_INNERBLOCK_ATTRIBUTES: () => (/* binding */ DEFAULT_INNERBLOCK_ATTRIBUTES)
/* harmony export */ });
/**
 ...
 */
const DEFAULT_INNERBLOCK = 'core/paragraph';

/**
 * These are the attributes we assign for our default
 * inner blocks.
 */
const DEFAULT_INNERBLOCK_ATTRIBUTES = {
...
/* harmony import */ var _swiper_init__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./swiper-init */ "./src/swiper-init.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./editor.scss */ "./src/editor.scss");
/* harmony import */ var _assets_image1_jpg__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./assets/image1.jpg */ "./src/assets/image1.jpg");
/* harmony import */ var _assets_image2_jpg__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./assets/image2.jpg */ "./src/assets/image2.jpg");
/* harmony import */ var _assets_image3_jpg__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./assets/image3.jpg */ "./src/assets/image3.jpg");
...
const SliderToolbar = ({
  ...
  const innerBlocks = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)((select // eslint-disable-line no-shadow
  ) => select(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.store).getBlock(clientId).innerBlocks);

  // Create a Slide block and insert it.
  const addSlide = () => {
    const block = (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.createBlock)(_constants__WEBPACK_IMPORTED_MODULE_8__.DEFAULT_BLOCK, {
      url: `${_assets_image3_jpg__WEBPACK_IMPORTED_MODULE_13__}`,
      ..._constants__WEBPACK_IMPORTED_MODULE_8__.DEFAULT_BLOCK_ATTRIBUTES
    });
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToolbarGroup, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToolbarButton, {
    icon: "plus",
    onClick: addSlide
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__.__)('Add Slide', 'wpe')));
};

/**
 * Slider component.
 */
const Slider = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_6__.memo)(({
  clientId,
  attributes,
  innerBlocksProps
}) => {
  const sliderRef = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_4__.useRefEffect)(element => {
    const options = {
      ...attributes,
      ...{
        autoplay: false,
    ...
    // Initialize slider.
    let slider = (0,_swiper_init__WEBPACK_IMPORTED_MODULE_9__.SwiperInit)(element, options);

    // Store the current slide order to detect changes, such as adding, removing, or reordering slides.
    let slideOrder = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.select)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.store).getBlockOrder(clientId);

    // Subscribe slider update events like adding, removing, or reordering slides.
    const unsubscribeSliderUpdateListener = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.subscribe)(() => {
      const currentSlidesOrder = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.select)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.store).getBlockOrder(clientId);

      // Check if the slider has been changed.
      if (currentSlidesOrder.toString() !== slideOrder.toString()) {
        const selectedBlock = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.select)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.store).getSelectedBlock();
        ...
        window.requestAnimationFrame(() => {
          // Initialize slider.
          slider = (0,_swiper_init__WEBPACK_IMPORTED_MODULE_9__.SwiperInit)(element, options);
          ...
          if (slideAdded) {
            ...
            slideToIndex = slideOrder.findIndex(clientId => clientId === selectedBlock.clientId // eslint-disable-line no-shadow
            );
          }
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.BlockControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(SliderToolbar, {
    ...
    ...innerBlocksProps
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.ButtonBlockAppender, {
...
function Edit({
  ...
  const innerBlocksProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useInnerBlocksProps)({
    ...
    allowedBlocks: _constants__WEBPACK_IMPORTED_MODULE_8__.ALLOWED_BLOCKS,
    defaultBlock: {
      name: _constants__WEBPACK_IMPORTED_MODULE_8__.DEFAULT_BLOCK,
      attributes: {
        url: `${_assets_image3_jpg__WEBPACK_IMPORTED_MODULE_13__}`,
        ..._constants__WEBPACK_IMPORTED_MODULE_8__.DEFAULT_BLOCK_ATTRIBUTES
      }
    ...
    template: [[_constants__WEBPACK_IMPORTED_MODULE_8__.DEFAULT_BLOCK, {
      url: `${_assets_image1_jpg__WEBPACK_IMPORTED_MODULE_11__}`,
      ..._constants__WEBPACK_IMPORTED_MODULE_8__.DEFAULT_BLOCK_ATTRIBUTES
    }, [[_constants__WEBPACK_IMPORTED_MODULE_8__.DEFAULT_INNERBLOCK, {
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__.__)('Slide title…', 'wpe'),
      ..._constants__WEBPACK_IMPORTED_MODULE_8__.DEFAULT_INNERBLOCK_ATTRIBUTES
    }]]], [_constants__WEBPACK_IMPORTED_MODULE_8__.DEFAULT_BLOCK, {
      url: `${_assets_image2_jpg__WEBPACK_IMPORTED_MODULE_12__}`,
      ..._constants__WEBPACK_IMPORTED_MODULE_8__.DEFAULT_BLOCK_ATTRIBUTES
    }, [[_constants__WEBPACK_IMPORTED_MODULE_8__.DEFAULT_INNERBLOCK, {
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__.__)('Slide title…', 'wpe'),
      ..._constants__WEBPACK_IMPORTED_MODULE_8__.DEFAULT_INNERBLOCK_ATTRIBUTES
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__.__)('Settings', 'wpe')
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__.__)('Autoplay', 'wpe'),
    checked: autoplay,
    onChange: value => setAttributes({
      autoplay: value
    }),
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__.__)('“Autoplay” will automatically advance the slides. Note: this is intentionally disabled in the editor, but will affect the front end.')
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelRow, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToggleControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__.__)('Navigation', 'wpe'),
    checked: navigation,
    onChange: value => setAttributes({
      navigation: value
    }),
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__.__)('“Navigation” will display arrows so user can navigate forward/backward.')
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelRow, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToggleControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__.__)('Pagination', 'wpe'),
    checked: pagination,
    onChange: value => setAttributes({
      pagination: value
    }),
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__.__)('“Pagination” will display dots along the bottom for user to click through slides.')
  })))));
}
 ...
 */
function SwiperInit(container, options = {}) {
  var _options$autoplay, _options$centerSlides, _options$grabCursor, _options$navigation, _options$pagination, _options$simulateTouc;
  const parameters = {
    autoplay: (_options$autoplay = options?.autoplay) !== null && _options$autoplay !== void 0 ? _options$autoplay : true,
...
module.exports = __webpack_require__.p + "images/image1.c6ef4cb9.jpg";
...
module.exports = __webpack_require__.p + "images/image2.d9e9aaec.jpg";
...
module.exports = __webpack_require__.p + "images/image3.59495149.jpg";
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wpe/slider","title":"Slider","category":"widgets","description":"Display your images in a horizontal carousel.","icon":"slides","keywords":["carousel","slideshow"],"attributes":{"autoplay":{"type":"boolean","default":true},"navigation":{"type":"boolean","default":true},"pagination":{"type":"boolean","default":true}},"example":{},"supports":{"html":false,"align":["wide","full"],"className":true,"color":{"background":true,"gradients":true,"link":true,"text":true},"spacing":{"padding":true,"margin":["top","bottom"]}},"textdomain":"wpe","version":"0.1.1","editorScript":"file:./index.js","editorStyle":"file:./index.css","render":"file:./render.php","style":"file:./style-index.css","viewScript":"file:./view.js"}');
