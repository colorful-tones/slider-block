...
function Edit() {
   ...
   */
  const allowedBlocks = (0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_2__.applyFilters)('colorful-tones.sliderBlock.allowedBlocks', ['core/button', 'core/buttons', 'core/cover', 'core/heading', 'core/image', 'core/paragraph']);
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"colorful-tones/slide","version":"0.1.4","title":"Slide","category":"widgets","icon":"cover-image","description":"Slides for the Slider block.","attributes":{"align":{"type":"string","default":"full"}},"example":{},"parent":["colorful-tones/slider"],"supports":{"align":["wide","full"],"className":true,"html":false},"textdomain":"slider-block","editorScript":"file:./index.js","render":"file:./render.php"}');
