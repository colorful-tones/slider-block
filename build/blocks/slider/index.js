...
/* harmony import */ var _swiper_init__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./swiper-init */ "./src/blocks/slider/swiper-init.js");
 ...
 *
 * @param  {Object}  useBlockEditContext.clientId Block ID.
...
const SliderToolbar = ({
  ...
  const addSlide = () => {
    const block = (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.createBlock)('colorful-tones/slide');
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToolbarGroup, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToolbarButton, {
    icon: "plus",
    onClick: addSlide
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__.__)('Add slide', 'slider-block')));
};

/**
 * Slides component.
 */
const Slides = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_6__.memo)(() => {
  const innerBlocksProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useInnerBlocksProps)({
    className: 'swiper-wrapper'
  }, {
    allowedBlocks: ['colorful-tones/slide'],
    template: [['colorful-tones/slide'], ['colorful-tones/slide']],
...
const Slider = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_6__.memo)(({
  ...
  const sliderRef = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_4__.useRefEffect)(element => {
    ...
    // Initialize slider.
    let slider = (0,_swiper_init__WEBPACK_IMPORTED_MODULE_8__.SwiperInit)(element, options);
    ...
    const unsubscribeSliderUpdateListener = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.subscribe)(() => {
      ...
      if (currentSlidesOrder.toString() !== slideOrder.toString()) {
        ...
        window.requestAnimationFrame(() => {
          // Initialize slider.
          slider = (0,_swiper_init__WEBPACK_IMPORTED_MODULE_8__.SwiperInit)(element, options);
  ...
  })), pagination && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
function Edit({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__.__)('Settings', 'slider-block')
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__.__)('Autoplay', 'slider-block'),
    checked: autoplay,
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__.__)('Navigation', 'slider-block'),
    checked: navigation,
    onChange: value => setAttributes({
      navigation: value
    }),
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__.__)('Pagination', 'slider-block'),
    checked: pagination,
    onChange: value => setAttributes({
      pagination: value
    }),
...
/***/ "./src/blocks/slider/swiper-init.js":
/*!******************************************!*\
  !*** ./src/blocks/slider/swiper-init.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function SwiperInit(container, options = {}) {
  var _options$centerSlides, _options$drag, _options$drag2, _options$slidesPerVie, _options$speed;
  const parameters = {
    autoplay: false,
    ...
    grabCursor: (_options$drag = options?.drag) !== null && _options$drag !== void 0 ? _options$drag : true,
    keyboard: true,
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Keyboard],
    navigation: false,
    pagination: false,
    simulateTouch: (_options$drag2 = options?.drag) !== null && _options$drag2 !== void 0 ? _options$drag2 : true,
    slidesPerView: (_options$slidesPerVie = options?.slidesPerView) !== null && _options$slidesPerVie !== void 0 ? _options$slidesPerVie : 1,
    speed: (_options$speed = options?.speed) !== null && _options$speed !== void 0 ? _options$speed : 300
  };

  // Autoplay module.
  if (options?.autoplay) {
    var _options$autoplayInte, _options$autoplayPaus;
    parameters.modules.push(swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay);
    parameters.autoplay = {
      delay: (_options$autoplayInte = options?.autoplayInterval) !== null && _options$autoplayInte !== void 0 ? _options$autoplayInte : 3000,
  ...
  if (options?.navigation) {
    parameters.modules.push(swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation);
  ...
  if (options?.pagination) {
    ...
    parameters.modules.push(swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination);
    parameters.pagination = {
      ...
      clickable: (_options$pagination$c = options?.pagination?.clickable) !== null && _options$pagination$c !== void 0 ? _options$pagination$c : false
    };
    if ('bullets' === parameters.pagination.type && undefined === options?.pagination?.clickable) {
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"colorful-tones/slider","title":"Slider","category":"widgets","description":"Display your images in a horizontal carousel.","icon":"slides","keywords":["carousel","slideshow"],"attributes":{"autoplay":{"type":"boolean","default":true},"navigation":{"type":"boolean","default":true},"pagination":{"type":"boolean","default":true},"slidesPerView":{"type":"number","default":1}},"example":{},"supports":{"html":false,"align":["wide","full"],"className":true,"color":{"background":true,"gradients":true,"link":true,"text":true},"spacing":{"padding":true,"margin":["top","bottom"]}},"textdomain":"slider-block","version":"0.1.4","editorScript":"file:./index.js","render":"file:./render.php","style":"file:./style-index.css","viewScript":"file:./view.js"}');
